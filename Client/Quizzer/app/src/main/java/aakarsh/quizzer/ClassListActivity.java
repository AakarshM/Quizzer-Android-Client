...
import static aakarsh.quizzer.Constants.SIGNUP_TEACHER;
import static aakarsh.quizzer.Constants.STUDENT_INFO;
...
public class ClassListActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent s = new Intent(getApplicationContext(), StudentInfoActivity.class);
        startActivity(s);
        finish();
...
// Add the request to the RequestQueue.
    ...
    public void generateList(){
        ...
        listAdapter = new ArrayAdapter<String>(ClassListActivity.this, android.R.layout.simple_list_item_1, classList);
        lview.setAdapter(listAdapter);
        lview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                CLASS_NAME = classList.get(position).toString().toLowerCase().replaceAll("\\s","");
